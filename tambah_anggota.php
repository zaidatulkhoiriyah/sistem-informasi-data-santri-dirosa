									...
									<div class="container">
										<div class="col-sm-10 form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<label class="radio">
														<input type="radio" data-toggle="radio" name="Lembaga_Sore" id="Lembaga_Sore1" value="Mahasiswa" data-radiocheck-toggle="radio" checked="" class="custom-radio"><span class="icons"><span class="icon-unchecked"></span><span class="icon-checked"></span></span>
														Mahasiswa
													</label>
													<label class="radio">
														<input type="radio" data-toggle="radio" name="Lembaga_Sore" id="Lembaga_Sore2" value="Siswa" data-radiocheck-toggle="radio" class="custom-radio"><span class="icons"><span class="icon-unchecked"></span><span class="icon-checked"></span></span>
														Siswa
													</label>
												</div>
											</div>
										...
										<div class="col-sm-10 form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													...
													<span class="help-block">example : http://facebook.com/an-najm</span>
												</div>
											</div>
											<!-- Twitter -->
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="twitter" id="twitter" class="form-control" placeholder="Twitter (@an-najm)">
												</div>
											</div>
										</div>
									</div>
