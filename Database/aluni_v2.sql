...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Okt 2021 pada 16.10
...
(1, '', 0, 0, '', '', 'admin', '2017-02-17 10:43:52', 'admin', '2021-10-30 17:11:26', 2),
(2, '', 0, 0, '', '', 'admin', '2021-10-30 18:02:09', 'admin', '2021-10-30 18:02:09', 0);
...
(1, 'Bayu Tutor', 'Bayu', 'laki-laki', 'Kota Bandung', '2017-02-16', '1', 0x7365646f74636f64652e6a7067, 1, 3, '<p>Jalan t<strong>erus jadian kapan</strong></p>', 'ya', 'admin', '2017-02-17 10:43:52', 'admin', '2021-10-30 17:11:26', 2),
(2, 'Dewi', 'Dewi', 'perempuan', 'Kota Bandung', '0000-00-00', '1', 0x646577692e706e67, 12, 0, '<p>jl, komplek cibiru</p>', 'ya', 'admin', '2021-10-30 18:02:09', 'admin', '2021-10-30 18:02:09', 0);
...
(1, '', '', 'admin', '2017-02-17 10:43:52', 'admin', '2021-10-30 17:11:26', 2),
(2, '', '', 'admin', '2021-10-30 18:02:09', 'admin', '2021-10-30 18:02:09', 0);
...
(1, '', '', '', '', '', 'http://sedotcode.blogspot.co.id/', '', '', 'admin', '2017-02-17 10:43:52', 'admin', '2021-10-30 17:11:26', 2),
(2, '', '', '', '', '', '', '', '', 'admin', '2021-10-30 18:02:09', 'admin', '2021-10-30 18:02:09', 0);
...
('dewi', '81947ea1cc9c8ffa66c19df1bbf522412c7b80e6eb34aadf3311e79a4ebe8752da525083294e2aaef6ba62e2a7f5107f3328dab7e75c54fa229528895b2e0ebe', 'c9a5da075f9e5c3e7a916570946fed4826e181656382e13696fbe0aaf1412bf5', 'user', 'ya', 'Dewi', '', 'dewi.png', 2, 'admin', '2021-10-30 18:02:09', 'admin', '2021-10-30 18:02:09', 0),
('sedotcode', 'a99f3ea53ec8cb8b648a2e4ae4e5a3f66fb6745b8ef1de1661605a6f5ecb10aca65da4acc2b664fbc269eda43555b29d07b6b451efb56a796b96a7a4997138e5', '83545a4189515cfe34f2e3637e192b7aba3d4ce77a7659be21c2e82d6b23742c', 'user', 'ya', 'Bayu Tutor', '', 'sedotcode.jpg', 1, 'admin', '2017-02-17 10:43:52', 'admin', '2021-10-30 17:11:26', 2);
...
(2, 'dewi', '0424c3c6', 'belum diubah', 'admin', '2021-10-30 18:02:09', 'admin', '2021-10-30 18:02:09');

-- --------------------------------------------------------

--
-- Stand-in struktur untuk tampilan `aluni_v_anggota_lengkap`
...
--
-- Stand-in struktur untuk tampilan `aluni_v_anggota_mentah`
-- (Lihat di bawah untuk tampilan aktual)
--
...
--
-- Stand-in struktur untuk tampilan `aluni_v_pengguna`
-- (Lihat di bawah untuk tampilan aktual)
--
...
--
-- Indeks untuk tabel `aluni_anggota_akademik`
--
ALTER TABLE `aluni_anggota_akademik`
  ADD PRIMARY KEY (`id_anggota`);

--
-- Indeks untuk tabel `aluni_anggota_dasar`
--
ALTER TABLE `aluni_anggota_dasar`
  ADD PRIMARY KEY (`id_anggota`);

--
-- Indeks untuk tabel `aluni_anggota_keluarga`
--
ALTER TABLE `aluni_anggota_keluarga`
  ADD PRIMARY KEY (`id_anggota`);

--
-- Indeks untuk tabel `aluni_anggota_kontak`
--
ALTER TABLE `aluni_anggota_kontak`
  ADD PRIMARY KEY (`id_anggota`);

--
-- Indeks untuk tabel `aluni_anggota_orang_tua`
--
ALTER TABLE `aluni_anggota_orang_tua`
  ADD PRIMARY KEY (`id_anggota`);

--
-- Indeks untuk tabel `aluni_m_agama`
--
ALTER TABLE `aluni_m_agama`
  ADD PRIMARY KEY (`id_agama`);

--
-- Indeks untuk tabel `aluni_m_kota`
--
ALTER TABLE `aluni_m_kota`
  ADD PRIMARY KEY (`id_kota`);

--
-- Indeks untuk tabel `aluni_m_modul`
--
ALTER TABLE `aluni_m_modul`
  ADD PRIMARY KEY (`id_modul`);

--
-- Indeks untuk tabel `aluni_m_provinsi`
--
ALTER TABLE `aluni_m_provinsi`
  ADD PRIMARY KEY (`id_provinsi`);

--
-- Indeks untuk tabel `aluni_pengaturan`
--
ALTER TABLE `aluni_pengaturan`
  ADD PRIMARY KEY (`id_pengaturan`);

--
-- Indeks untuk tabel `aluni_pengguna`
--
ALTER TABLE `aluni_pengguna`
  ADD PRIMARY KEY (`username`);

--
-- Indeks untuk tabel `aluni_pengguna_hak_akses`
--
ALTER TABLE `aluni_pengguna_hak_akses`
  ADD PRIMARY KEY (`username`);

--
-- Indeks untuk tabel `aluni_pengguna_status_password`
--
...
--
-- AUTO_INCREMENT untuk tabel `aluni_anggota_dasar`
--
ALTER TABLE `aluni_anggota_dasar`
  MODIFY `id_anggota` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `aluni_m_agama`
--
ALTER TABLE `aluni_m_agama`
  MODIFY `id_agama` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `aluni_m_kota`
--
ALTER TABLE `aluni_m_kota`
  MODIFY `id_kota` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=499;

--
-- AUTO_INCREMENT untuk tabel `aluni_m_modul`
--
ALTER TABLE `aluni_m_modul`
  MODIFY `id_modul` int(3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `aluni_m_provinsi`
--
ALTER TABLE `aluni_m_provinsi`
  MODIFY `id_provinsi` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT untuk tabel `aluni_pengaturan`
--
ALTER TABLE `aluni_pengaturan`
