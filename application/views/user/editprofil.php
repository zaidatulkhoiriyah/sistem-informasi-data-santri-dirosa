...
<form action="<?php echo site_url('User/updateProfil');?>" method="post">
	...
	<select class="select2 form-control">
			<option selected="selected" value="<?php echo $user['id_kamarasal'];?>"><?php echo $user['datasantri'];?></option>
			<?php foreach($pk as $a){ ?>
				<option value="<?php echo $a->id_pk ;?>"><?php echo $a->jenis_pk;?></option>
			<?php };?>
		</select><br>
	<input placeholder="I" type="text" name="instansi" class="form-control" value="<?php echo $user['instansi'];?>"><br>
