								...
								<form action="pencarian.php" method="post">
									...
									<div class="form-group">
										...
										<label class="checkbox" for="cari_provinsi">
											<input type="checkbox" data-toggle="checkbox" value="provinsi" id="cari_provinsi" name="kategori_pencarian[]" class="custom-checkbox"><span class="icons"><span class="icon-unchecked"></span><span class="icon-checked"></span></span> kamar asal
										</label>
										<label class="checkbox" for="cari_kota">
											<input type="checkbox" data-toggle="checkbox" value="kota" id="cari_kota" name="kategori_pencarian[]" class="custom-checkbox"><span class="icons"><span class="icon-unchecked"></span><span class="icon-checked"></span></span> nama ketua kamar asal
										</label>
						...
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<div class="img-responsive">
									...
									<div>
										<span style="background-color:#F7464A"> &nbsp;&nbsp;&nbsp;&nbsp; </span> &nbsp; Mahasiswa : <?php echo $n_anggota_laki; ?>
										<br>
										<span style="background-color:#46BFBD"> &nbsp;&nbsp;&nbsp;&nbsp; </span> &nbsp; Siswa : <?php echo $n_anggota_perempuan; ?>
										<br>
